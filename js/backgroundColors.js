...
function backgroundColorAction() {
  const [highlight, background, multiplier] = utils.getDial(this, ['highlight', 'background', 'multiplier']);
...
function backgroundColorActionHover() {
  ...
  return (colorAction.lightness > 10
    ...
    : colorAction.darken(10)).contrastWith(background, 15 * multiplier);
}
...
function backgroundColorNavSolid() { // currently only used for NavBar background opacity
